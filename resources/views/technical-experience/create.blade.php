...
<main id="main">
    <section id="about" class="about">
         <div class="container" data-aos="fade-up">
          ...
          <form class="form-horizontal" id="technical-exp-form">
            @csrf
              ...
              <a class="btn btn-secondary" href=" {{route('additional-experience.index')}} " role="button">Skip</a>
...
$("#technical-exp-form").submit(function(e){
  e.preventDefault();
