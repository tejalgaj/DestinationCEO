...
<main id="main">
    <section id="about" class="about">
         <div class="container" data-aos="fade-up">
          ...
          <form action="{{route('user-detail.update', $userDetail->id)}}" method='POST' class="form-horizontal">
            @csrf
            @method('PUT')
            <div class="form-row">
 ...
 <script type="text/javascript">
     ...
     jQuery("#userdetail-startdate").datepicker( {
    format: "yyyy-mm",
    startView: "months", 
    minViewMode: "months"
});
...
jQuery("#userdetail-enddate").datepicker( {
    format: "yyyy-mm",
    startView: "months", 
    minViewMode: "months"
});
