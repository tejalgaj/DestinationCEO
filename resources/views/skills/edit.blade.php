         ...
         <div class="container" data-aos="fade-up">
          ...
          <form action="{{route('skills.update', $skill->id)}}" method='POST' class="form-horizontal">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('skill_title') ? 'is-invalid' : ''}}" id="skills-title" placeholder="e.g.Languages" name="skill_title" value="{{$skill->skill_title}}" required>
               @error('skill_title')
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control {{ $errors->has('value') ? 'is-invalid' : ''}}" id="skills-value" placeholder="e.g.Phython,JavaScript" name="value" value="{{$skill->value}}" required>
               @error('value')
               <div class="invalid-feedback">
               {{$errors->first('value')}}
              </div>
